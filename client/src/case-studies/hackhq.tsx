...
const HackHQ = () => (
  ...
  >
    ...
    <CSSection n={3} title="Key decisions" accent="oxblood" width="grid">
    ...
    <CSSection n={4} title="Keeping a directory alive" accent="oxblood" width="grid">
      <Figure
        n={1}
        caption="The freshness loop — expiry is a designed state, not a bug. Past-deadline events age out of default views instead of rotting in place."
        width="grid"
        className="!px-0"
      >
        <FlowDiagram
    ...
    <CSSection n={5} title="The shipped product" accent="oxblood" width="grid">
      <div className="space-y-10">
        <Figure
          n={2}
        ...
        <Figure n={3} caption="The live directory — hover to play." width="grid" keyline className="!px-0">
          <HoverVideo
            video={{
    ...
    <CSSection n={6} title="What I'd test next" accent="oxblood">
      <p>
        ...
        honest freshness metadata beats implied perfection — the same principle as this
        portfolio&rsquo;s status labels.
      </p>
